...
Will change as implemnation happens but genral paln for now

## Phase 1: Project Setup

- [X] Decide input type (single file vs small project) **Small Project**
- [X] Choose LLM access method (API / local model) **Hybrid**
